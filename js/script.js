...
$(function() {
    ...
    if ($('.audio-player').length) {
        ...
        var myPlaylist = new jPlayerPlaylist({
            ...
            artist: "The Harmonics Choir Hong Kong",
            mp3: "songs/Bohemian Rhapsody - The Harmonics Choir Hong Kong.mp3",
            oga: "songs/Bohemian Rhapsody - The Harmonics Choir Hong Kong.ogg"
        }, {
            title: "Star Wars (John Williams is the Man)",
            artist: "The Harmonics Choir Hong Kong",
            mp3: "songs/Star Wars - The Harmonics Choir Hong Kong.mp3",
            oga: "songs/Star Wars - The Harmonics Choir Hong Kong.ogg"
        }, {
            title: "Stand By Mean /Lean On Me",
            artist: "The Harmonics Choir Hong Kong",
            mp3: "songs/Stand by me Lean on me - The Harmonics Choir Hong Kong.mp3",
            oga: "songs/Stand by me Lean on me - The Harmonics Choir Hong Kong.ogg"
        }, {
            title: "Mamma Mia!",
            artist: "The Harmonics Choir Hong Kong",
            mp3: "songs/Mama Mia - The Harmonics Choir Hong Kong.mp3",
            oga: "songs/Mama Mia - The Harmonics Choir Hong Kong.ogg"
        }, {
            title: "Shallow - Lady Gaga",
            artist: "The Harmonics Choir Hong Kong",
            mp3: "songs/Shallow - The Harmonics Choir Hong Kong.mp3",
            oga: "songs/Shallow - The Harmonics Choir Hong Kong.ogg"
        }, {
            title: "海闊天空 Far Away - BEYOND",
            artist: "The Harmonics Choir Hong Kong",
            mp3: "songs/海闊天空(Far Away) - The Harmonics Choir Hong Kong.mp3",
            oga: "songs/海闊天空(Far Away) - The Harmonics Choir Hong Kong.ogg"
        }], {
            swfPath: "js/plugins",
            supplied: "oga, mp3",
            wmode: "window",
