...
$to    = "georgemuyinie@gmail.com"; // <--- Your email ID here

$server_email = 'no-reply@web3canvas.com';  // Your server email to authenticate outgoing emails. eg: name@yourdomain.com
...
if (isset($email) && isset($name)) {
	...
	$subject  = "[Duotone] New Message from $name"; // <--- Contact for Subject here.
 
	$msg      = 'Hello Admin, <br/> <br/> Here are the message details:';

	// Message will Auto populate from the HTML Form Elements
